...
-- São necessárias várias subqueries para obter o resultado, que é:


-- Vamos analisar essa consulta em partes. A primeira parte a ser executada é a destacada em amarelo.
...
-- Em seguida, a consulta destacada em rosa é executada. A segunda consulta utiliza o resultado da consulta em amarelo como se fosse uma tabela, já que está entre parênteses no FROM. Essa tabela virtual é chamada de tab1.
